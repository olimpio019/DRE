                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd>
                        <div className="text-lg font-medium text-gray-900">
                          <a href="/sales" className="hover:text-indigo-600">
                            Gerenciar Vendas
                          </a>
                        </div>
                      </dd>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd>
                        <div className="text-lg font-medium text-gray-900">
                          <a href="/expenses" className="hover:text-indigo-600">
                            Gerenciar Despesas
                          </a>
                        </div>
                      </dd>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd>
                        <div className="text-lg font-medium text-gray-900">
                          <a href="/clients" className="hover:text-indigo-600">
                            Gerenciar Clientes
                          </a>
                        </div>
                      </dd>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd>
                        <div className="text-lg font-medium text-gray-900">
                          <a href="/results" className="hover:text-indigo-600">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd>
                        <Link href="/departments" className="text-sm font-medium text-indigo-600 hover:text-indigo-500">
